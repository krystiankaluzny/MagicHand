...
//    cam.open("data/video/zamykanie.avi");
    cam.open("data/video/przenoszenie2.avi");
    if(!cam.isOpened())
    {
...
//    VideoWriter video("data/video/przenoszenie2.avi",(int)cam.get(CV_CAP_PROP_FOURCC), 16, Size((int)cam.get(CV_CAP_PROP_FRAME_WIDTH),(int)cam.get(CV_CAP_PROP_FRAME_HEIGHT)) );
