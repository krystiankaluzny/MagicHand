...
//    cam.open("data/video/przenoszenie2.avi");
    ...
    VideoWriter video("data/video/przenoszenie3.avi",(int)cam.get(CV_CAP_PROP_FOURCC), 16, Size((int)cam.get(CV_CAP_PROP_FRAME_WIDTH),(int)cam.get(CV_CAP_PROP_FRAME_HEIGHT)) );
